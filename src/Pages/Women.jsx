...
const Women = (props) =>{
  ...
  return (
    <div className='sm:m-[auto]'>
      ...
      <img className='lg:m-[auto] mt-[30px] mb-[30px] lg:w-[82%]' src="./imgs/woman banner.jpeg" alt="" />
      <div className='flex mt-0 mb-0  lg:mr-[170px] lg:ml-[170px] justify-between items-center'>
        <p>
      ...
      <div className=' grid lg:grid-cols-[1fr,1fr,1fr,1fr] mt-[20px] mr-[170px] :ml-[170px] mb-[20px] sm:m-[auto] row-gap-[30px]'>
