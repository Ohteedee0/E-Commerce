...
const Kids = (props) =>{
  ...
  return (
    <div>
      ...
      <img className='m-[auto] mt-[30px] mb-[30px] w-[82%]' src="./imgs/kids banner.jpeg" alt="" />
      ...
      <div  className=' lg:grid lg:grid-cols-[1fr,1fr,1fr,1fr] mt-[20px] mr-[170px] lg:ml-[170px] mb-[20px]  row-gap-[30px]'>
